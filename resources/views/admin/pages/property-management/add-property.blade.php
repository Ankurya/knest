...
<div class="content">
   ...
   <div class="container-fluid">
      <div class="row">
         <div class="col-lg-12">
            <div class="card_bg">
               <h3 class="np-left">Add Property</h3>
                        ...
                        <tbody>
                                 ...
                                 <div class="restru_images" style="">
                                    ...
                                    <div class="media_inputs">
                                       <div class="img_upload upload_images">
                                          ...
                                          <img src="{{url('public/admin/assets/img/add_image.png')}}" class="images_placehold" title="Upload image" data-recursion="-1" />
                                       </div>
                                    </div>
                                    <div class="clr"></div>
                                    <label class="custom_error" id="image_error" style="display: none; margin-top: 0; width: 100% !important;"></label>
                                 </div>
                              </td>
                           </tr>
                           <tr>
                              ...
                              <td>
                                 <div class="field">
                                    <div class="form-group">
                                       <input type="text" class="form-control" maxlength="8" name = "property_price" value = "{{old('property_price')}}" placeholder="Property Price"><span class="material-input"></span>
                              ...
                              <td>
                                 <div class="field">
                                    <select name="number_of_bedroom"  class="selectpicker bedroom_type" >
                                       <option value="">Select Number of Bedroom </option>
                              ...
                              <td>
                                  <div class="field">
                                    <select name="number_of_bathroom"  class="selectpicker bathroom_type" >
                                       <option value="">Select Number of Bathroom</option>
                                       <option value="1">1</option>
                                       <option value="2">2</option>
                                       <option value="3">3</option>
                                       <option value="4">4</option>
                           ...
                           <tr>
                              ...
                              <td>
                                 <div class="field">
                                    <div class="form-group">
                                       <input type="text" id="autocomplete" name = "address" maxlength="150" value = "{{old('address')}}"  class="form-control" placeholder="Address"><span class="material-input"></span>
                                       <label id="address-error" class="error" for="address" >{{$errors->first('address')}}</label>
                                        <input type="hidden" id="lat_val" name="lat" value="{{old('lat')}}">
                                       <input type="hidden" id="long_val" name="long" value="{{old('long')}}">
                                    </div>
                                 </div>
                              </td>
                           </tr>
                             <tr>
                              ...
                              <td>
                                 <div class="field date-time">
                                    <div class="cal w100">
                                       <span> <input type="text"  name = "date" maxlength="50"  value = "{{old('date')}}" id="datepicker-3" placeholder="Select Date" class="form-control datepicker" readonly='true'> <i class="fa fa-calendar" aria-hidden="true"></i></span>
                           ...
                           <tr>
                              ...
                              <td>
                                 <div class="field">
                                    <div class="cal w100">
                                       <div class="clockpicker start_time " data-placement="right" data-align="top" data-autoclose="true">
                                          <input type="text" name ="start_time" id="start_time" value = "{{old('start_time')}}" placeholder="Select Start Time" class="form-control" readonly='true'>
                                 ...
                                 <div class="field">
                                    <div class="cal w100">
                                       <div class="clockpicker1" data-placement="right" data-align="top" data-autoclose="true">
                                          <input type="text" name ="end_time" placeholder="Select End Time" id="end_time" value = "{{old('end_time')}}" class="form-control" readonly='true'>
                                          <span class="input-group-addon first">
                                          <span class="glyphicon glyphicon-time"></span>
                                          </span>
                           ...
                           <tr>
                              ...
                              <td>
                                 <div class="field">
                                    <div class="form-group">
                                       <input type="text" name = "tax" maxlength="10" value = "{{old('tax')}}"  class="form-control" placeholder="Tax(optional)"><span class="material-input"></span>
                           ...
                           <tr>
                              ...
                              <td>
                                 <div class="field">
                                    <div class="form-group">
                                       <input type="text" name = "plot_size" maxlength="10" value = "{{old('plot_size')}}"  class="form-control" placeholder="Plot Size(sqft)(optional)"><span class="material-input"></span>
                           ...
                           <tr>
                              ...
                              <td>
                                 <div class="field">
                                    <div class="form-group">
                                       <input type="text" name = "building_size" maxlength="10" value = "{{old('building_size')}}"  class="form-control" placeholder="Building Size(sqft)(optional)"><span class="material-input"></span>
                           ...
                           <tr>
                              ...
                              <td>
                                 <div class="field">
                                    <div class="form-group">
                                       <input type="text" name = "school_district" maxlength="50" value = "{{old('school_district')}}"  class="form-control" placeholder="School/District(optional)"><span class="material-input"></span>
                              ...
                              <td>
                                 <div class="field">
                                    <div class="form-group"><textarea class="form-control" maxlength="400" name ="description" style="height: 150px;" placeholder="Description">{{old('description')}}</textarea><span class="material-input"></span>
                           ...
                           <tr>
                              <td></td>
                              <td><button type="submit" id="submit_btn" class="btn btnlink submit">Add</button></td>
                           </tr>
                        </tbody>
                     </table>
                  </form>
...
<script src="{{url('public/admin/assets/js/addMultipleImages.js')}}"></script>
...
<script>
   ...
   function validate_form(){
     let image = $(".upload_images").val();
            let media_prev = $(".media_preview").find('.upload_images').length;
            if(media_prev == 0) {
               ...
               required : true
                ...
                messages: {
                 ...
                 school_district: {
                  ...
                  property_image : {
                  required : "Please upload property image."
                 },
                  date : {
