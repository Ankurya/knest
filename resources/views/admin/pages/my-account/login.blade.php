            ...
            <div class="row">
                ...
                {{csrf_field()}}
                        ...
                        <div class="form-group">
                            ...
                            <span class="text-danger email_error_show"></span>
                        </div>
                        <div class="form-group">
                            <input type="password" id="password" name="password" class="form-control" placeholder="Password" required>
                            <span class="text-danger password_error_show"></span>
                        </div>
                        <div class="form-group">
                       	  <p> <span><a href="{{route('admin.forgotPassword')}}" class="btn-for">Forgot password?</a></span></p>
                        </div>
                        <div class="form-group submit">
                            <button type="submit" class="button">Login</button>
                            <!-- <a href="{{route('admin.dashboard')}}" class="button">Login</a> -->
                            <!-- <button id="login_btn" onclick="return login();" class="button">Login</button> -->
